...
const professionals = [
  ...
  },
  {
    ...
    priceBadge: "Atendimento rápido",
    qualityBadge: "Avaliação alta",
    services: [
      { title: "Troca de tomadas", price: "R$ 70-110" },
      { title: "Quadro de distribuição", price: "R$ 220-360" },
      { title: "Iluminação", price: "R$ 90-140" },
    ],
  },
  {
    name: "Pedro Martins",
    ...
    priceBadge: "Preço justo",
    qualityBadge: "Muito recomendado",
    services: [
      { title: "Instalação de luminárias", price: "R$ 80-130" },
      { title: "Reparo elétrico", price: "R$ 90-160" },
      { title: "Inspeção elétrica", price: "R$ 120-190" },
    ],
  },
  {
    name: "Ana Ribeiro",
  ...
  },
  {
    ...
    verified: true,
    distance: "2,2 km",
    response: "Resposta em 8 min",
    priceBadge: "Excelente custo",
    qualityBadge: "Nota máxima",
    services: [
      { title: "Limpeza pós-obra", price: "R$ 180-260" },
      { title: "Faxina semanal", price: "R$ 120-180" },
      { title: "Organização", price: "R$ 90-140" },
    ],
  },
  {
    name: "Juliana Castro",
    ...
    verified: false,
    distance: "4,5 km",
    response: "Resposta em 18 min",
    priceBadge: "Pontualidade",
    qualityBadge: "Muito elogiada",
    services: [
      { title: "Limpeza residencial", price: "R$ 110-170" },
      { title: "Limpeza de cozinha", price: "R$ 80-130" },
      { title: "Passadoria", price: "R$ 60-90" },
    ],
  },
  {
    name: "Joao Pires",
  ...
  },
  {
    ...
    verified: true,
    distance: "2,6 km",
    response: "Resposta em 14 min",
    priceBadge: "Paisagismo",
    qualityBadge: "Muito elogiado",
    services: [
      { title: "Jardinagem completa", price: "R$ 140-220" },
      { title: "Paisagismo", price: "R$ 240-380" },
      { title: "Poda e manutenção", price: "R$ 110-180" },
    ],
  },
  {
    name: "Camila Rocha",
    ...
    verified: false,
    distance: "3,8 km",
    response: "Resposta em 22 min",
    priceBadge: "Preço acessível",
    qualityBadge: "Clientes fiéis",
    services: [
      { title: "Poda ornamental", price: "R$ 100-160" },
      { title: "Plantio", price: "R$ 120-190" },
      { title: "Cuidados semanais", price: "R$ 150-230" },
    ],
  },
  {
    name: "Marina Lopes",
  ...
  },
  {
    ...
    verified: true,
    distance: "3,4 km",
    response: "Resposta em 16 min",
    priceBadge: "Atendimento urgente",
    qualityBadge: "Muito recomendado",
    services: [
      { title: "Troca de registro", price: "R$ 80-130" },
      { title: "Reparo em vazamento", price: "R$ 140-220" },
      { title: "Instalação de chuveiro", price: "R$ 90-150" },
    ],
  },
  {
    name: "Carla Mendes",
    ...
    verified: true,
    distance: "2,9 km",
    response: "Resposta em 11 min",
    priceBadge: "Atendimento premium",
    qualityBadge: "Nota máxima",
    services: [
      { title: "Desentupimento", price: "R$ 130-210" },
      { title: "Troca de torneira", price: "R$ 80-120" },
      { title: "Reparo hidráulico", price: "R$ 160-240" },
    ],
  },
  {
    name: "Lucas Costa",
  ...
  },
  {
    ...
    distance: "4,6 km",
    response: "Resposta em 22 min",
    priceBadge: "Equipe ágil",
    qualityBadge: "Qualidade garantida",
    services: [
      { title: "Pintura rápida", price: "R$ 200-320" },
      { title: "Troca de piso", price: "R$ 350-520" },
      { title: "Reforma de banheiro", price: "R$ 900-1400" },
    ],
  },
  {
    name: "Renata Alves",
    ...
    response: "Resposta em 18 min",
    priceBadge: "Bom custo",
    qualityBadge: "Entrega rápida",
    services: [
      { title: "Reparo de parede", price: "R$ 180-260" },
      { title: "Drywall", price: "R$ 260-420" },
      { title: "Reforma parcial", price: "R$ 500-850" },
    ],
  },
  {
    name: "Patricia Dias",
  ...
  },
  {
    ...
    verified: true,
    distance: "2,1 km",
    response: "Resposta em 9 min",
    priceBadge: "Acabamento fino",
    qualityBadge: "Muito elogiada",
    services: [
      { title: "Pintura interna", price: "R$ 210-340" },
      { title: "Pintura externa", price: "R$ 300-460" },
      { title: "Textura decorativa", price: "R$ 190-270" },
    ],
  },
  {
    name: "Roberto Silva",
    ...
    verified: false,
    distance: "3,6 km",
    response: "Resposta em 19 min",
    priceBadge: "Preço competitivo",
    qualityBadge: "Ótimas avaliações",
    services: [
      { title: "Pintura comercial", price: "R$ 260-420" },
      { title: "Pintura residencial", price: "R$ 230-360" },
      { title: "Efeito cimento", price: "R$ 200-300" },
    ],
  },
];
